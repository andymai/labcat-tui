...
export const rosePine: ThemeDefinition = defineTheme({
  ...
  subagentRed: '#eb6f92',
  subagentBlue: '#9ccfd8',
  subagentGreen: '#9ccfd8',
  subagentYellow: '#f6c177',
  subagentPurple: '#c4a7e7',
  subagentOrange: '#ebbcba',
  subagentPink: '#ebbcba',
  subagentCyan: '#9ccfd8',
...
export const rosePineDawn: ThemeDefinition = defineTheme({
  ...
  subagentRed: '#b4637a',
  subagentBlue: '#286983',
  subagentGreen: '#56949f',
  subagentYellow: '#ea9d34',
  subagentPurple: '#907aa9',
  subagentOrange: '#d7827e',
  subagentPink: '#b4637a',
  subagentCyan: '#56949f',
